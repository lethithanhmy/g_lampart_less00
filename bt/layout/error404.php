...
<head>
    ...
    <link rel="stylesheet" href="<?php echo __FOLDER."public/error404/css/style.css"?>">
</head>
<body>
    <!-- Page Loader    -->
      <div class="spinner">
    ...
    <nav class="navigation">
        <ul>
            <li><a href="<?php echo __FOLDER.'index.php?rt=index'?>">Product.html</a></li>
            <li><a href="<?php echo __FOLDER.'index.php?rt=index/productDetail'?>">Product_detail.html</a></li>
            <li><a href="<?php echo __FOLDER.'index.php?rt=index/productManager'?>">Product_manager.html</a></li>
            <li><a href="<?php echo __FOLDER.'index.php?rt=index/createAccount'?>">Create_account.html</a></li>
   ...
   <section class="error">
       ...
       <p>Why don't you try one of the below links?</p>
   </section>
  ...
  <div id="svg_container">
   ...
   <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script src="<?php echo __FOLDER."public/error404/js/code.js"?>"></script>
