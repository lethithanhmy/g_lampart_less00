<div class="left_box_content">
                     <div class="left_thanh_tieu_de_content">
                        <div class="left_text_tieu_de">DU LỊCH NƯỚC NGOÀI</div>
                     </div>
                     <!---->
                     <?php
						$result =$obj->query("SELECT tour.* FROM tour,diadanh_tour, diadanh WHERE tour.Ma_tour=diadanh_tour.Ma_tour AND diadanh_tour.Ma_dia_danh=diadanh.Ma_dia_danh AND diadanh.Ma_loai_tour='nn' AND AnHien=1 LIMIT 0,2");
					?>
                             <?php
...
?>
                     ...
                     <p style="padding: 0; margin-top: 20px; float: right; clear: both; width: 250px">
                        ...
                        <a href="index.php?mod=tour&ac=loai&idloai=nn#left_panel" style="color: #539610; border-bottom: solid 1px #539610">
                        Xem thêm</a> </span>
                     </p>
                  </div>