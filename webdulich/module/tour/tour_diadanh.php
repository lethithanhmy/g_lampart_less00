<?php
$diadanh = utils::getIndex("iddiadanh");
$arr=array("Ma_dia_danh"=>$diadanh);
$result =$obj->selectWithBindParam("SELECT tour.*,diadanh.Ten_dia_danh FROM tour,diadanh_tour, diadanh WHERE tour.Ma_tour=diadanh_tour.Ma_tour AND diadanh_tour.Ma_dia_danh=diadanh.Ma_dia_danh AND AnHien=1 AND diadanh.Ma_dia_danh=:Ma_dia_danh",$arr);
?>
<div class="left_box_content">
                     <div class="left_thanh_tieu_de_content">
                        <div class="left_text_tieu_de">DU LỊCH</div>
                     </div>
                     <!---->
...
<!--                     <p style="padding: 0; margin-top: 20px; float: right; clear: both; width: 250px">
                        ...
                        <a href="du-lich-nuoc-ngoai.html#left_panel" style="color: #539610; border-bottom: solid 1px #539610">
                        Xem thêm</a> </span>
                     </p>-->
                  </div>