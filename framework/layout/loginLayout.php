...
<html class=" ">
    <head>
        ...
        <link href="<?php echo __PATH_URL ?>public/assets/plugins/icheck/skins/square/orange.css" rel="stylesheet" type="text/css" media="screen"/>
    ...
    <body class=" login_page">
        ...
        <div class="login-wrapper">
            <div id="login" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8">
                <h1><a href="#" title="Login Page" tabindex="-1">Lesson 1</a></h1>
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="<?php echo __PATH_URL ?>public/assets/plugins/icheck/icheck.min.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
